...
export function StageNav() {
  ...
  return (
    <div className="overflow-x-auto border-t border-white/5 bg-black/30" role="navigation" aria-label="Page sections">
      <Container>
        <ol className="flex items-center gap-4 py-4 text-sm">
          {stages.map((stage) => {
