...
const metadata = {
    ...
    description: "Premium rebuild of the Docker multi-language hello-world project. Animated layouts, reusable NextUI components, and a static export ready for GitHub Pages."
};
